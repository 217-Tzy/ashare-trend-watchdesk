const stocks = [
  ...
  },
  {
    ...
    risk: "涨幅接近 10%，次日容易高开分歧；30/60 日线只作为加分项，若明天承接弱不能重仓追。",
    action: "只等回踩承接，不追高开",
    trend: [14.1, 14.2, 14.3, 14.4, 14.5, 14.7, 14.9, 15.1, 15.3, 15.6, 15.9, 16.2, 16.4],
    tech: "收盘 16.35，MA5 14.57、MA10 14.20、MA20 14.69，量比约 3.16，属于高切低阶段的轻伏龙观察，重点看尾盘承接和次日延续。",
  ...
  },
  {
    ...
    tech: "收盘接近日内高位，符合高切低轻伏龙候选；需要明天复核 5/10 日线是否继续平滑上移，以及 20 日线附近承接是否可靠。",
  ...
  },
  {
    ...
    tech: "收盘接近日内高位，日内强度够；当前按轻伏龙观察，不强制 30/60 日线，但要在行情软件复核 5/10/20 日均线位置。",
...
const checklist = [
  ...
  "题材次日有延续逻辑或催化",
  "个股是板块中军或龙头",
  "轻伏龙可放宽 30/60 日线，但不能跌破或弱收 20 日线",
  "5/10 日线平滑上移，收盘不能远离均线过度透支",
  "尾盘分时重心上移且承接强",
  "当日温和放量，避免放量长上影",
];
...
const screenMeta = {
  date: "2026-07-20 收盘",
  title: "轻伏龙高切低观察池",
  note: "当前主线转换、高切低阶段，30/60 日线改为加分项，不再一票否决；但必须用板块资金流入、20 日线不弱收、5/10 日线平滑上移、尾盘承接强来替代过滤。",
  boards: "主线参考：电力/公用事业、煤炭、石油石化；消费只作次级观察。标准伏龙和轻伏龙分开复核。",
};
...
function statusLabel(status) {
  if (status === "good") return "中军承接";
  if (status === "wait") return "轻伏龙观察";
  return "高风险";
}
