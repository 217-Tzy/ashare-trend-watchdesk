const stocks = [
  ...
  },
  {
    ...
    mode: ["swing", "watch"],
    status: "wait",
    tags: ["00开头", "全球化制造", "成交稳定"],
    fit: "家电和工业技术龙头，海外业务基础深，适合作为 00 开头里的稳健波段观察。",
    risk: "弹性通常弱于题材股，短线更依赖家电和消费板块整体强度。",
    action: "等板块同步走强再看",
    trend: [62, 62.4, 63, 63.6, 64.1, 64.7, 65.2, 65.8, 66.1, 66.6, 67, 67.3, 67.8],
    tech: "更适合看 MA20/MA60 平滑上移后的低吸，早盘快速冲高不适合追。",
    overseas: "海外业务和全球供应链基础较强，适合放在高海外收入白名单里观察。",
    margin: "家电龙头毛利率通常较稳定，重点看季度报里盈利质量是否延续。",
    capital: "需要用券商或东方财富近 10 日资金页复核外资和主力方向。",
    tips: ["只在板块不弱时做波段。", "缩量回踩均线比放量追高更合适。", "若消费白马整体走弱，降低优先级。"],
  },
  {
    code: "300750",
    name: "宁德时代",
    mode: ["intraday", "swing"],
    status: "good",
    tags: ["30开头", "高流动性", "新能源核心"],
    fit: "创业板核心权重，成交活跃，适合纳入 30 开头短线趋势观察。",
    risk: "新能源板块周期波动明显，单日振幅可能放大。",
    action: "只做板块共振的强承接",
    trend: [185, 188, 191, 193, 196, 199, 202, 205, 209, 213, 216, 220, 224],
    tech: "适合观察 MA20/MA60 上方的午后承接；如果板块高开低走，不做单票硬抗。",
    overseas: "全球动力电池客户基础较强，海外扩张是长期观察点之一。",
    margin: "毛利率受材料价格和产品结构影响，短线更看板块资金和分时强度。",
    capital: "盘前必须复核近 10 日北向/主力资金是否持续回流。",
    tips: ["新能源指数同步走强才提高优先级。", "下午回踩 VWAP 不破再考虑。", "大幅高开后长上影要回避。"],
  },
  {
    code: "300760",
    name: "迈瑞医疗",
    ...
    status: "wait",
    tags: ["30开头", "医疗器械", "高毛利"],
    fit: "医疗器械龙头，毛利率和海外业务属性强，适合作为 30 开头的波段观察股。",
    risk: "医疗板块估值和政策预期会影响短线弹性。",
    action: "等趋势修复后低吸",
    trend: [245, 244, 246, 248, 250, 253, 255, 257, 259, 261, 262, 264, 266],
    tech: "偏波段型，等均线重新顺排后再看；不适合板块弱势时追反弹。",
    overseas: "海外医疗设备业务是重要增长观察点，适合纳入海外业务筛选。",
    margin: "医疗器械龙头毛利率较高，但仍需看最新财报是否保持稳定。",
    capital: "近 10 日资金方向需盘前人工复核，不能只看长期基本面。",
    tips: ["医疗板块弱势时只观察。", "趋势刚修复时仓位要轻。", "若跌破 MA20 且放量，移出短线池。"],
  },
];
