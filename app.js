const stocks = [
  {
    ...
    overseas: "工程机械、制造出海、基建链。只有板块资金流入且同板块多数个股同步走强时，才把它放入当日核心池。",
    margin: "当日最好温和放量，尾盘站稳分时均线；若放量但分时重心下移，视为资金兑现而不是承接。",
    capital: "盘前用券商或东方财富复核板块资金、概念资金和近 10 日陆股通/主力资金是否同步回流。",
    tips: ["先看工程机械板块资金是否流入。", "下午缩量回踩不破分时均线才考虑。", "若板块龙头高开低走，不单独买入。", "次日上午冲高不封强时先卖。"],
  },
  {
    code: "000338",
    name: "潍柴动力",
    ...
    overseas: "商用车、动力总成、氢能和高端装备链。适合作为低价中军观察，而不是单纯题材小票。",
    margin: "更看重温和放量和分时重心抬升；横盘放量但价格不走强时，不算有效伏龙形态。",
    capital: "近 10 日资金方向必须盘前人工复核；若资金分歧大，只放观察。",
    tips: ["先确认商用车/动力链资金流入。", "优先看量能温和放大。", "跌回 MA20 下方不做超短线。", "横盘缩量时等方向选择。"],
  },
  {
    code: "002241",
    name: "歌尔股份",
    ...
    overseas: "消费电子、MR/VR、苹果链。只有消费电子概念资金回流时，才符合板块先行。",
    margin: "理想形态是当日放量、分时低点逐步抬高、尾盘仍在均价线上方；高开低走直接剔除。",
    capital: "盘前复核近 10 日主力资金和北向变化，资金转弱时不追。",
    tips: ["VR/消费电子板块同步强才提高优先级。", "优先选择概念中成交额靠前的中军。", "长上影后至少观察一天。", "次日上午不延续就卖。"],
  },
  {
    code: "600406",
    name: "国电南瑞",
    ...
    overseas: "智能电网、电力设备、特高压。适合作为电网方向的中军，前提是板块资金明显流入。",
    margin: "放量突破 5/10 日线后，尾盘能稳住才是有效确认；放量长上影要降级。",
    capital: "近 10 日资金若持续流入，才纳入当日超短线池。",
    tips: ["先看电网设备板块强度。", "不要在板块冲高回落时接。", "下午能站回 VWAP 才考虑。", "跌破 MA20 后只看不买。"],
  },
  {
    code: "002415",
    name: "海康威视",
    ...
    overseas: "AI 视觉、安防、人工智能应用。适合作为 AI 应用方向的中军观察，但政策消息会影响延续性。",
    margin: "尾盘必须看到承接，最好全天分时重心逐级抬升；单纯早盘放量冲高不算合格。",
    capital: "外资偏好会随政策预期变化，近 10 日资金必须人工复核。",
    tips: ["先看 AI 应用/安防概念资金。", "消息敏感日降低仓位。", "缩量回踩比追涨更好。", "若跌破 MA60 不做短线趋势。"],
  },
  {
    code: "600298",
    name: "安琪酵母",
    ...
    overseas: "食品饮料、发酵、消费防守方向。更适合波段观察，只有消费板块走强时才提高优先级。",
    margin: "量价上不追求爆量，重点是缩量回踩不破 20 日线、随后温和放量修复。",
    capital: "近 10 日资金方向若没有明显回流，只放波段观察。",
    tips: ["先看消费防守板块是否回流。", "只在缩量回踩均线时看。", "早盘冲高不强不恋战。", "放量长上影后等两天。"],
  },
  {
    code: "002179",
    name: "中航光电",
    ...
    overseas: "军工电子、高端连接器、低空经济链。题材轮动强，必须先看概念资金延续。",
    margin: "量价要看放量突破后能否尾盘不回落；如果只冲高不收回 5/10 日线，不算标准伏龙。",
    capital: "题材轮动时资金进出快，盘中只看强承接。",
    tips: ["军工电子板块不强时只观察。", "放量冲高回落要回避。", "跌破 MA20 后移出短线池。"],
  },
  {
    code: "603338",
    name: "浙江鼎力",
    ...
    overseas: "高空作业平台、工程机械、制造出海。更偏趋势波段，适合在板块资金回流时做弹性观察。",
    margin: "成交额弱于大中军，尾盘必须确认量能够用；无量上移容易次日冲高回落。",
    capital: "近 10 日没有资金回补时只放观察池。",
    tips: ["先看工程机械/出海链延续性。", "不追早盘第一波。", "成交额不足时不做重仓。", "等待突破后缩量回踩确认。"],
  },
  {
    code: "601138",
    name: "工业富联",
    ...
    overseas: "AI 服务器、算力、电子制造。适合作为 AI 硬件链的中军，必须和板块共振。",
    margin: "成交额要持续维持，尾盘不能破 VWAP；放量下杀说明资金分歧，不做伏龙买点。",
    capital: "盘前复核近 10 日资金是否连续回流，盘中看成交额是否维持。",
    tips: ["先看 AI 算力链资金是否继续流入。", "大幅高开不追。", "下午破 VWAP 不买。", "次日上午不延续先兑现。"],
  },
  {
    code: "002475",
    name: "立讯精密",
    ...
    overseas: "消费电子、苹果链、汽车电子。适合作为消费电子方向的中军，需看板块延续性。",
    margin: "理想量价是板块强、个股温和放量、尾盘承接不破均价线；高位爆量分歧要回避。",
    capital: "需要复核近 10 日北向和主力资金是否同向。",
    tips: ["先看消费电子概念资金流入。", "不追高开长阳。", "成交额必须维持活跃。", "若消费电子板块转弱，先降级。"],
  },
];
